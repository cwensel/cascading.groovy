...
println "  updating to: ${groovyProfile}"

ant.touch(file: groovyProfile)

ant.exec(executable: 'sed')
  {
    arg(value: '-i')
    arg(value: '-e')
    arg(value: '/.*cascading.*/d')
    arg(value: groovyProfile)
  }

groovyProfile << 'new cascading.groovy.startup.LoadHadoop().register()\n'
